...
return array(
    ...
    '1' => array('name' => lang('menu/index'), 'icon' => 'xe625', 'sub' => array(
        ...
        '26' => array("show"=>1,"name" => lang('menu/external'), 'controller' => 'system',				'action' => 'external'),

        '24' => array("show"=>1,"name" => lang('menu/rep'), 'controller' => 'rep',				'action' => 'index'),

        '25' => array("show"=>1,"name" => lang('menu/admin'), 'controller' => 'system',				'action' => 'admin'),
        '27' => array("show"=>1,"name" => lang('menu/template'), 'controller' => 'template',				'action' => 'index'),
        '28' => array("show"=>1,"name" => lang('menu/sync'), 'controller' => 'sync',				'action' => 'index'),
