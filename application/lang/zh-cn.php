...
return [
    ...
    'admin/system/config/external_status'=>'外链处理',
    'admin/system/config/external_status_tip'=>'不开启的话外部链接默认不处理',
    'admin/system/config/external_mode'=>'处理方式',
    'admin/system/config/external_mode0'=>'框架',
    'admin/system/config/external_mode1'=>'跳转',
    'admin/system/config/external_mode_tip'=>'外链载入方式',
    'admin/system/config/external_file'=>'文件名',
    'admin/system/config/external_file_tip'=>'需要同时修改根目录下的link.php文件名',
    'admin/system/config/ignore_domain'=>'忽略域名',
    'admin/system/config/ignore_domain_tip'=>'比如外部的下载链接、友情链接等等，多个用|分隔',
    'admin/system/config/external_encode'=>'是否加密',
    'admin/system/config/external_encode_tip'=>'转换为link?url=外链加密地址',
    'admin/system/config/ignore_suffix'=>'忽略文件后缀',
    'admin/system/config/ignore_suffix_tip'=>'有些后缀的文件处理会出错的，请添加上去，比如压缩文件、视频文件等修改会乱码的文件，多个用|分隔',
